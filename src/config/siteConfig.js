export const siteConfig = {
  ...
  heroDescription:
    'I am an Information Technology graduate with hands-on experience in remote administrative work, data reporting, and practical web-based systems. I handle calendar and email coordination, CRM tasks, applicant screening, spreadsheet organization, dashboard preparation, technical documentation, and project presentations.',
  heroTags: ['System Development', 'Cybersecurity', 'Data Analytics', 'Technical Documentation', 'UI/UX'],
  heroProofPoints: [
  ...
  navigationLinks: [
    ...
    { label: 'Credentials', href: '#trainings' },
